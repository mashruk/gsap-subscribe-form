...
form.onsubmit = function onSubmitHandler(event) {
  ...
  div.textContent = "".concat(JSON.stringify(values, 2));
...
button.addEventListener("click", function (event) {
  ...
  if (!state.toggled) {
    _gsap.default.to(["form", "header"], {
      opacity: 0,
      duration: 0.1,
      pointerEvents: "none"
    });

    _gsap.default.to("section", {
      height: "70px",
      duration: 0.5
    });

    _gsap.default.to(".outro-section", {
      x: 0,
      delay: 0.5,
      duration: 0.3,
...
},{"./styles.scss":"src/styles.scss","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
